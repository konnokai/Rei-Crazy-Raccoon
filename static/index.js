(function(w) {
    ...
    w.gameInit = function() {
        createjs.Sound.registerSound({
            src: "./static/sound/ReiRei_Hoyo.mp3",
            id: "err"
        });
        createjs.Sound.registerSound({
            src: "./static/sound/ReiRei_I_am_raccon.mp3",
            id: "end"
        });
        createjs.Sound.registerSound({
            src: "./static/sound/ReiRei_Naaa.mp3",
            id: "tap"
        });
        gameRestart();
    }
    ...
    w.shareText = function(score) {
        ...
        if (score <= 99) return '你這個沙發馬澪薯';
        if (score <= 149) return '不錯喔 澪薯';
        if (score <= 199) return '厲害ㄟ 是個很快的澪薯';
        return '你手速也太快了吧 你難道是萬年單身澪薯?';
    }
